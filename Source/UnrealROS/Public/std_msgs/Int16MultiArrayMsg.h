...
#include "Int16MultiArrayMsg.generated.h"
...
class UNREALROS_API UInt16MultiArrayMsg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UInt16MultiArrayMsg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UInt16MultiArrayMsg() : URosMessageBase("std_msgs/Int16MultiArray")
	{
		m_layout = NewObject<UMultiArrayLayoutMsg>();
	};

	//--------------------------------------------------------------------------
	// Name:        UInt16MultiArrayMsg destructor
	// Description: Default destructor.
	//--------------------------------------------------------------------------
	~UInt16MultiArrayMsg() override
	{
		...
		void set_contents(UMultiArrayLayoutMsg* layout, TArray<int> data)
	{
		...
		for (size_t i = 0; i < data.Num(); i++)
			m_data.Add(static_cast<int16_t>(data[i]));
	}
