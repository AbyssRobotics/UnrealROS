...
// Unreal ROS Plugin
//
// Description: Defines the std_msgs/Int64MultiArray ROS message and its 
//              interface with JSON.
//==============================================================================
#pragma once
...
#include "Int64MultiArrayMsg.generated.h"
...
class UNREALROS_API UInt64MultiArrayMsg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UInt64MultiArrayMsg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UInt64MultiArrayMsg() : URosMessageBase("std_msgs/Int64MultiArray")
	{
		m_layout = NewObject<UMultiArrayLayoutMsg>();
	};

	//--------------------------------------------------------------------------
	// Name:        UInt64MultiArrayMsg destructor
	// Description: Default destructor.
	//--------------------------------------------------------------------------
	~UInt64MultiArrayMsg() override
	{
		...
		void set_contents(UMultiArrayLayoutMsg* layout, TArray<int> data)
	{
		...
		for (size_t i = 0; i < data.Num(); i++)
			m_data.Add(static_cast<int64_t>(data[i]));
	}
