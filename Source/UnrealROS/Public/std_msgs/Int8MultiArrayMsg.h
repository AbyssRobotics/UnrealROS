...
// Unreal ROS Plugin
//
// Description: Defines the std_msgs/Int8MultiArray ROS message and its 
//              interface with JSON.
//==============================================================================
#pragma once
...
#include "Int8MultiArrayMsg.generated.h"
...
class UNREALROS_API UInt8MultiArrayMsg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UInt8MultiArrayMsg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UInt8MultiArrayMsg() : URosMessageBase("std_msgs/Int8MultiArray")
	{
		m_layout = NewObject<UMultiArrayLayoutMsg>();
	};

	//--------------------------------------------------------------------------
	// Name:        UInt8MultiArrayMsg destructor
	// Description: Default destructor.
	//--------------------------------------------------------------------------
	~UInt8MultiArrayMsg() override
	{
