...
// Unreal ROS Plugin
//
// Description: Defines the std_msgs/UInt32MultiArray ROS message and its 
//              interface with JSON.
//==============================================================================
#pragma once
...
#include "UInt32MultiArrayMsg.generated.h"
...
class UNREALROS_API UUInt32MultiArrayMsg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UUInt32MultiArrayMsg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UUInt32MultiArrayMsg() : URosMessageBase("std_msgs/UInt32MultiArray")
	{
		m_layout = NewObject<UMultiArrayLayoutMsg>();
	};

	//--------------------------------------------------------------------------
	// Name:        UUInt32MultiArrayMsg destructor
	// Description: Default destructor.
	//--------------------------------------------------------------------------
	~UUInt32MultiArrayMsg() override
	{
		...
		void set_contents(UMultiArrayLayoutMsg* layout, TArray<int> data)
	{
		...
		for (size_t i = 0; i < data.Num(); i++)
			m_data.Add(static_cast<uint32_t>(data[i]));
	}
