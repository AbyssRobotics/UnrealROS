...
// Unreal ROS Plugin
//
// Description: Defines the std_msgs/UInt8 ROS message and its interface with
//              JSON.
//==============================================================================
#pragma once
...
class UNREALROS_API UUInt8Msg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UUInt8Msg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UUInt8Msg() : URosMessageBase("std_msgs/UInt8")
	{

	}

	//--------------------------------------------------------------------------
	// Name:        UUInt8Msg destructor
