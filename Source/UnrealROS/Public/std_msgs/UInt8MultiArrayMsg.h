...
// Unreal ROS Plugin
//
// Description: Defines the std_msgs/UInt8MultiArray ROS message and its 
//              interface with JSON.
//==============================================================================
#pragma once
...
#include "UInt8MultiArrayMsg.generated.h"
...
class UNREALROS_API UUInt8MultiArrayMsg : public URosMessageBase
{
...
public:
	...
	//--------------------------------------------------------------------------
	// Name:        UUInt8MultiArrayMsg constructor
	// Description: Default constructor.
	//--------------------------------------------------------------------------
	UUInt8MultiArrayMsg() : URosMessageBase("std_msgs/UInt8MultiArray")
	{
		m_layout = NewObject<UMultiArrayLayoutMsg>();
	};

	//--------------------------------------------------------------------------
	// Name:        UUInt8MultiArrayMsg destructor
	// Description: Default destructor.
	//--------------------------------------------------------------------------
	~UUInt8MultiArrayMsg() override
	{
		...
		void set_contents(UMultiArrayLayoutMsg* layout, TArray<int> data)
	{
		...
		for (size_t i = 0; i < data.Num(); i++)
			m_data.Add(static_cast<uint8_t>(data[i]));
	}
